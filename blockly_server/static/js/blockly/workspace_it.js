...
Blockly.Blocks['move_forward_default'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Avanti di un passo");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(290);
    this.setTooltip("");
...
Blockly.Blocks['move_reverse_default'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Indietro di un passo");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(290);
    this.setTooltip("");
...
Blockly.Blocks['turn_right_90'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Girare di 90 gradi a destra");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(290);
    this.setTooltip("");
...
Blockly.Blocks['turn_left_90'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Girare di 90 gradi a sinistra");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(290);
    this.setTooltip("");
...
Blockly.Blocks['set_color'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Scegli")
      .appendField(new Blockly.FieldDropdown([["rosso", "'red'"], ["verde", "'green'"], ["blu", "'blue'"], ["bianco", "'white'"], ["viola", "'violet'"], ["ciano", "'cyan'"], ["giallo", "'yellow'"], ["chiuso", "'closed'"]]), "color_option")
      .appendField("colore");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(290);
  ...
  Blockly.Blocks['play_sound'] = {
    ...
    generateOptions: function () {
      ...
      if (received_data.status == 200) {
        ...
        return new Array(["","Nessuna opzione"])
      }
    }
  };
});
...
Blockly.Blocks['noise_detection'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Rilevamento del rumore");
...
Blockly.Blocks['check_for_obstacle'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Rilevamento di ostacoli");
    this.setOutput(true, 'Boolean');
    this.setColour(45);
    this.setTooltip("");
    this.setHelpUrl("");
...
Blockly.Blocks['check_for_line'] = {
  init: function () {
    this.appendDummyInput()
      .appendField(new Blockly.FieldDropdown([["sinistra", "3"], ["centro", "1"], ["destra", "2"]]), "check_for_line_option")
      .appendField("Rilevamento della linea nera");
    this.setOutput(true, 'Boolean');
    this.setColour(45);
    this.setTooltip("");
    this.setHelpUrl("");
...
Blockly.Blocks['floor_sensor'] = {
  init: function () {
    this.appendDummyInput()
      .appendField(new Blockly.FieldDropdown([["sinistra", "3"], ["centro", "1"], ["destra", "2"]]), "floor_sensor_option")
      .appendField("Sensore del pavimento");
    this.setOutput(true, 'Number');
    this.setColour(45);
    this.setTooltip("");
    this.setHelpUrl("");
...
Blockly.Blocks['get_last_move_distance'] = {
  init: function () {
    this.appendDummyInput()
      .appendField(new Blockly.FieldDropdown([["sinistra", "left "], ["destra", "right"]]), "option")
      .appendField("Distanza dell'ultimo movimento");
    this.setOutput(true, 'Number');
    this.setColour(45);
    this.setTooltip("");
    this.setHelpUrl("");
...
Blockly.Blocks['get_acceleration'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Accelerazione sull'asse")
...
Blockly.Blocks['get_gyroscope'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Valore del giroscopio sull'asse")
      .appendField(new Blockly.FieldDropdown([["x", "x"], ["y", "y"], ["z", "z"]]), "option");
    this.setOutput(true, 'Number');
    this.setColour(45);
    this.setTooltip("");
