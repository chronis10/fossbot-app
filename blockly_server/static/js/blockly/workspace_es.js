...
Blockly.Blocks['move_reverse_default'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Retroceder un paso");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(290);
    this.setTooltip("");
...
Blockly.Blocks['turn_right_90'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Girar 90 grados a la derecha");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(290);
    this.setTooltip("");
...
Blockly.Blocks['turn_left_90'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Girar 90 grados a la izquierda");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(290);
    this.setTooltip("");
...
Blockly.Blocks['set_color'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Elegir")
      .appendField(new Blockly.FieldDropdown([["rojo", "'red'"], ["verde", "'green'"], ["azul", "'blue'"], ["blanco", "'white'"], ["violeta", "'violet'"], ["cian", "'cyan'"], ["amarillo", "'yellow'"], ["cerrado", "'closed'"]]), "color_option")
      .appendField("color");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(290);
...
Blockly.Blocks['noise_detection'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Detección de ruido");
...
Blockly.Blocks['check_for_obstacle'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Detección de obstáculo");
    this.setOutput(true, 'Boolean');
    this.setColour(45);
    this.setTooltip("");
    this.setHelpUrl("");
...
Blockly.Blocks['check_for_line'] = {
  init: function () {
    this.appendDummyInput()
      .appendField(new Blockly.FieldDropdown([["izquierda", "3"], ["centro", "1"], ["derecha", "2"]]), "check_for_line_option")
      .appendField("Detección de línea negra");
    this.setOutput(true, 'Boolean');
    this.setColour(45);
    this.setTooltip("");
    this.setHelpUrl("");
...
Blockly.Blocks['floor_sensor'] = {
  init: function () {
    this.appendDummyInput()
      .appendField(new Blockly.FieldDropdown([["izquierda", "3"], ["centro", "1"], ["derecha", "2"]]), "floor_sensor_option")
      .appendField("Sensor de suelo");
    this.setOutput(true, 'Number');
    this.setColour(45);
    this.setTooltip("");
    this.setHelpUrl("");
...
Blockly.Blocks['get_last_move_distance'] = {
  init: function () {
    this.appendDummyInput()
      .appendField(new Blockly.FieldDropdown([["izquierda", "left "], ["derecha", "right"]]), "option")
      .appendField("Distancia del último movimiento");
    this.setOutput(true, 'Number');
    this.setColour(45);
    this.setTooltip("");
    this.setHelpUrl("");
...
Blockly.Blocks['get_acceleration'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Aceleración en el eje")
...
Blockly.Blocks['get_gyroscope'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Valor del giroscopio en el eje")
      .appendField(new Blockly.FieldDropdown([["x", "x"], ["y", "y"], ["z", "z"]]), "option");
    this.setOutput(true, 'Number');
    this.setColour(45);
    this.setTooltip("");
...
Blockly.Blocks['get_timer'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Tiempo transcurrido");
    this.setOutput(true, 'Number');
    this.setColour(290);
    this.setTooltip("");
    this.setHelpUrl("");
