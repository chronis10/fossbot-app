...
Blockly.Blocks['rotate_degrees'] = {
  init: function () {
    ...
    this.setNextStatement(true, null);
    this.setColour(290);
    this.setTooltip("Rotate the robot by a specific angle and direction.");
    this.setHelpUrl("");
  }
};
...
Blockly.Blocks['obstacle_sensor'] = {
  init: function () {
    this.appendDummyInput()
      ...
      .appendField(new Blockly.FieldDropdown([["front left", "0"], ["front right", "1"], ["back left", "2"], ["back right", "3"]]), "obstacle_sensor_option");
    this.setOutput(true, 'Number');
    this.setColour(45);
    this.setTooltip("");
    this.setHelpUrl("");
