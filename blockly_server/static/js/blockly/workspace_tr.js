...
Blockly.Blocks['move_forward_default'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Bir adım ileri git");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(290);
    this.setTooltip("");
...
Blockly.Blocks['turn_right_90'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("90 derece sağa dön");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(290);
    this.setTooltip("");
...
Blockly.Blocks['turn_left_90'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("90 derece sola dön");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(290);
    this.setTooltip("");
...
Blockly.Blocks['set_color'] = {
  init: function () {
    this.appendDummyInput()
      ...
      .appendField(new Blockly.FieldDropdown([["kırmızı", "'red'"], ["yeşil", "'green'"], ["mavi", "'blue'"], ["beyaz", "'white'"], ["mor", "'violet'"], ["camgöbeği", "'cyan'"], ["sarı", "'yellow'"], ["kapalı", "'closed'"]]), "color_option")
      .appendField("rengi");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(290);
...
Blockly.Blocks['check_for_line'] = {
  init: function () {
    this.appendDummyInput()
      .appendField(new Blockly.FieldDropdown([["sol", "3"], ["orta", "1"], ["sağ", "2"]]), "check_for_line_option")
      .appendField("Siyah çizgi algılama");
    this.setOutput(true, 'Boolean');
    this.setColour(45);
    this.setTooltip("");
    this.setHelpUrl("");
...
Blockly.Blocks['floor_sensor'] = {
  init: function () {
    this.appendDummyInput()
      .appendField(new Blockly.FieldDropdown([["sol", "3"], ["orta", "1"], ["sağ", "2"]]), "floor_sensor_option")
      .appendField("Zemin sensörü");
    this.setOutput(true, 'Number');
    this.setColour(45);
    this.setTooltip("");
    this.setHelpUrl("");
...
Blockly.Blocks['get_last_move_distance'] = {
  init: function () {
    this.appendDummyInput()
      .appendField(new Blockly.FieldDropdown([["sol", "left "], ["sağ", "right"]]), "option")
      .appendField("Son hareket mesafesi");
    this.setOutput(true, 'Number');
    this.setColour(45);
    this.setTooltip("");
    this.setHelpUrl("");
...
Blockly.Blocks['begin_timer'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Zamanlayıcıyı başlat");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(290);
    this.setTooltip("");
...
Blockly.Blocks['stop_timer'] = {
  init: function () {
    this.appendDummyInput()
      .appendField("Zamanlayıcıyı durdur");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(290);
    this.setTooltip("");
